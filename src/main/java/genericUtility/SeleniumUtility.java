...
public class SeleniumUtility {
	...
	/**
	 * This is generic method to select an option in dropdown by its index
	 * @param dropdownEle
	 * @param index
	 */
	...
	/**
	 * This is an generic method to select an option in dropdown by its visible text
	 * @param dropdownEle
	 * @param visibleText
	 */
...
///////////////////////Handling Mouse Action***********//////////////////////
	...
	/**
	 * This is generic method to perform mouse hovering action on webelement
	 * @param driver
	 * @param element
	 */
	...
	/**
	 * This is a method to accept alert popup
	 * @param driver
	 */
	...
	/**
	 * This is a method to dismiss alert popup
	 * @param driver
	 */
	...
	/**
	 * This is generic method to switch to a frame using frame index
	 * @param driver
	 * @param frameIndex
	 */
	...
	/**
	 * This is a generic method to take Screenshot
	 * @param driver
