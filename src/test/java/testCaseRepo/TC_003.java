...
public class TC_003 extends BaseClass {
	...
	public void LE003() throws EncryptedDocumentException, Exception {
	...
	//	Assert.fail();
		...
		String noOfEmployee=eUtil.getSingleCellDataFromExcel("Leads", 7, 4);
		...
		cnlp.createNewLead(lName, company, title, noOfEmployee, mobile, city, state, country);
		Thread.sleep(2000);
